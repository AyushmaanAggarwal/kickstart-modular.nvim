...
vim.keymap.set('n', '<leader><Tab>', function() vim.cmd(":wincmd w") end, { desc = "Toggle between windows" })
...
vim.keymap.set('n', '<leader>t', function() require('neo-tree.command').execute({toggle=true}) end, { desc = 'Open [T]ree' })

-- [[ Configure Treesitter ]]
-- See `:help nvim-treesitter`
require('nvim-treesitter.configs').setup {
  -- Add languages to be installed here that you want installed for treesitter
  ensure_installed = { 'bash', 'c', 'cpp', 'go', 'latex', 'lua', 'python', 'rust', 'javascript', 'typescript', 'vimdoc', 'vim', 'markdown', 'markdown_inline' },
